        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
...

            {
                isEdit
                    ...
                    : <p className='font-medium text-3xl text-neutral-950 mt-4'>{userData.name}</p>
            }
                    ...
                    <p className='font-medium'>Address:</p>
                    {
                        isEdit
                            ? <p>
                                ...
                                <input className='bg-gray-100' onChange={(e) => setUserData(prev => ({ ...prev, address, line1: e.target.value }))} value={userData.address.line2} type="text" />
                            </p>
